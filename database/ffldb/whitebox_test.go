...
// a slice of them.
func loadBlocks(t *testing.T, dataFile string, network wire.BitcoinNet) ([]*mtcutil.Block, error) {
	...
	blocks := make([]*mtcutil.Block, 0, 256)
	genesis := mtcutil.NewBlock(chaincfg.MainNetParams.GenesisBlock)
