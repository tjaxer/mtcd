...
const (
	...
	defaultMaxFeeRate = mtcutil.SatoshiPerBitcoin / 10
)
...
func (r FutureGetRawTransactionResult) Receive() (*mtcutil.Tx, error) {
	...
	return mtcutil.NewTx(&msgTx), nil
}
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*mtcutil.Tx, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []btcjson.TransactionInput,
	amounts map[mtcutil.Address]mtcutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {
...
func (c *Client) CreateRawTransaction(inputs []btcjson.TransactionInput,
	amounts map[mtcutil.Address]mtcutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsAsync(address mtcutil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
...
func (c *Client) SearchRawTransactions(address mtcutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerboseAsync(address mtcutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address mtcutil.Address, skip,
