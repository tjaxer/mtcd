...
func (c *Client) ListUnspentMinMaxAddressesAsync(minConf, maxConf int, addrs []mtcutil.Address) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses(minConf, maxConf int, addrs []mtcutil.Address) ([]btcjson.ListUnspentResult, error) {
...
func (c *Client) SetTxFeeAsync(fee mtcutil.Amount) FutureSetTxFeeResult {
...
func (c *Client) SetTxFee(fee mtcutil.Amount) error {
...
func (c *Client) SendToAddressAsync(address mtcutil.Address, amount mtcutil.Amount) FutureSendToAddressResult {
...
func (c *Client) SendToAddress(address mtcutil.Address, amount mtcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendToAddressCommentAsync(address mtcutil.Address,
	amount mtcutil.Amount, comment,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendToAddressComment(address mtcutil.Address, amount mtcutil.Amount, comment, commentTo string) (*chainhash.Hash, error) {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress mtcutil.Address, amount mtcutil.Amount) FutureSendFromResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress mtcutil.Address, amount mtcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendFromMinConfAsync(fromAccount string, toAddress mtcutil.Address, amount mtcutil.Amount, minConfirms int) FutureSendFromResult {
	addr := toAddress.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromMinConf(fromAccount string, toAddress mtcutil.Address, amount mtcutil.Amount, minConfirms int) (*chainhash.Hash, error) {
...
func (c *Client) SendFromCommentAsync(fromAccount string,
	toAddress mtcutil.Address, amount mtcutil.Amount, minConfirms int,
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFromComment(fromAccount string, toAddress mtcutil.Address,
	amount mtcutil.Amount, minConfirms int,
...
func (c *Client) SendManyAsync(fromAccount string, amounts map[mtcutil.Address]mtcutil.Amount) FutureSendManyResult {
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendMany(fromAccount string, amounts map[mtcutil.Address]mtcutil.Amount) (*chainhash.Hash, error) {
...
func (c *Client) SendManyMinConfAsync(fromAccount string,
	amounts map[mtcutil.Address]mtcutil.Amount,
...
func (c *Client) SendManyCommentAsync(fromAccount string,
	amounts map[mtcutil.Address]mtcutil.Amount, minConfirms int,
...
func (r FutureAddMultisigAddressResult) Receive() (mtcutil.Address, error) {
	...
	return mtcutil.DecodeAddress(addr, r.network)
}
...
func (c *Client) AddMultisigAddressAsync(requiredSigs int, addresses []mtcutil.Address, account string) FutureAddMultisigAddressResult {
...
func (c *Client) AddMultisigAddress(requiredSigs int, addresses []mtcutil.Address, account string) (mtcutil.Address, error) {
...
func (c *Client) CreateMultisigAsync(requiredSigs int, addresses []mtcutil.Address) FutureCreateMultisigResult {
	addrs := make([]string, 0, len(addresses))
	for _, addr := range addresses {
		addrs = append(addrs, addr.String())
	}
...
// multisignature address and script needed to redeem it.
func (c *Client) CreateMultisig(requiredSigs int, addresses []mtcutil.Address) (*btcjson.CreateMultiSigResult, error) {
...
// address.
func (r FutureGetNewAddressResult) Receive() (mtcutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
// chain params.
func (c *Client) GetNewAddress(account string) (mtcutil.Address, error) {
...
func (r FutureGetRawChangeAddressResult) Receive() (mtcutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetRawChangeAddress(account string) (mtcutil.Address, error) {
...
// address.
func (r FutureAddWitnessAddressResult) Receive() (mtcutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) AddWitnessAddress(address string) (mtcutil.Address, error) {
...
func (r FutureGetAccountAddressResult) Receive() (mtcutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetAccountAddress(account string) (mtcutil.Address, error) {
...
func (c *Client) GetAccountAsync(address mtcutil.Address) FutureGetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetAccount(address mtcutil.Address) (string, error) {
...
func (c *Client) SetAccountAsync(address mtcutil.Address, account string) FutureSetAccountResult {
	addr := address.EncodeAddress()
...
func (c *Client) SetAccount(address mtcutil.Address, account string) error {
...
func (r FutureGetAddressesByAccountResult) Receive() ([]mtcutil.Address, error) {
	res, err := receiveFuture(r.responseChannel)
	if err != nil {
		return nil, err
	}
	...
	addresses := make([]mtcutil.Address, len(addrStrings))
	for i, addrString := range addrStrings {
		addresses[i], err = mtcutil.DecodeAddress(addrString, r.network)
		if err != nil {
			return nil, err
		}
	}
...
// passed account.
func (c *Client) GetAddressesByAccount(account string) ([]mtcutil.Address, error) {
...
func (c *Client) MoveAsync(fromAccount, toAccount string, amount mtcutil.Amount) FutureMoveResult {
...
func (c *Client) Move(fromAccount, toAccount string, amount mtcutil.Amount) (bool, error) {
...
func (c *Client) MoveMinConfAsync(fromAccount, toAccount string,
	amount mtcutil.Amount, minConfirms int) FutureMoveResult {
...
func (c *Client) MoveMinConf(fromAccount, toAccount string, amount mtcutil.Amount, minConf int) (bool, error) {
...
func (c *Client) MoveCommentAsync(fromAccount, toAccount string,
	amount mtcutil.Amount, minConfirms int, comment string) FutureMoveResult {
...
func (c *Client) MoveComment(fromAccount, toAccount string, amount mtcutil.Amount,
...
func (c *Client) ValidateAddressAsync(address mtcutil.Address) FutureValidateAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) ValidateAddress(address mtcutil.Address) (*btcjson.ValidateAddressWalletResult, error) {
...
func (r FutureListAccountsResult) Receive() (map[string]mtcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	accountsMap := make(map[string]mtcutil.Amount)
	for k, v := range accounts {
		amount, err := mtcutil.NewAmount(v)
		if err != nil {
			return nil, err
		}
...
func (c *Client) ListAccounts() (map[string]mtcutil.Amount, error) {
...
func (c *Client) ListAccountsMinConf(minConfirms int) (map[string]mtcutil.Amount, error) {
...
func (r FutureGetBalanceResult) Receive() (mtcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
	...
	amount, err := mtcutil.NewAmount(balance)
	if err != nil {
		return 0, err
	}
...
// Receive waits for the response promised by the future and returns the
// available balance from the server for the specified account.
func (r FutureGetBalanceParseResult) Receive() (mtcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetBalance(account string) (mtcutil.Amount, error) {
...
func (c *Client) GetBalanceMinConf(account string, minConfirms int) (mtcutil.Amount, error) {
...
func (r FutureGetReceivedByAccountResult) Receive() (mtcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
// confirmations.
func (c *Client) GetReceivedByAccount(account string) (mtcutil.Amount, error) {
...
func (c *Client) GetReceivedByAccountMinConf(account string, minConfirms int) (mtcutil.Amount, error) {
...
func (r FutureGetUnconfirmedBalanceResult) Receive() (mtcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetUnconfirmedBalance(account string) (mtcutil.Amount, error) {
...
func (r FutureGetReceivedByAddressResult) Receive() (mtcutil.Amount, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetReceivedByAddressAsync(address mtcutil.Address) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
// confirmations.
func (c *Client) GetReceivedByAddress(address mtcutil.Address) (mtcutil.Amount, error) {
...
func (c *Client) GetReceivedByAddressMinConfAsync(address mtcutil.Address, minConfirms int) FutureGetReceivedByAddressResult {
	addr := address.EncodeAddress()
...
func (c *Client) GetReceivedByAddressMinConf(address mtcutil.Address, minConfirms int) (mtcutil.Amount, error) {
...
func (c *Client) SignMessageAsync(address mtcutil.Address, message string) FutureSignMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SignMessage(address mtcutil.Address, message string) (string, error) {
...
func (c *Client) VerifyMessageAsync(address mtcutil.Address, signature, message string) FutureVerifyMessageResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) VerifyMessage(address mtcutil.Address, signature, message string) (bool, error) {
...
// (WIF)
func (r FutureDumpPrivKeyResult) Receive() (*mtcutil.WIF, error) {
	res, err := receiveFuture(r)
	if err != nil {
		return nil, err
	}
	...
	return mtcutil.DecodeWIF(privKeyWIF)
}
...
func (c *Client) DumpPrivKeyAsync(address mtcutil.Address) FutureDumpPrivKeyResult {
	addr := address.EncodeAddress()
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) DumpPrivKey(address mtcutil.Address) (*mtcutil.WIF, error) {
...
func (c *Client) ImportPrivKeyAsync(privKeyWIF *mtcutil.WIF) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
...
// format (WIF).
func (c *Client) ImportPrivKey(privKeyWIF *mtcutil.WIF) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyLabelAsync(privKeyWIF *mtcutil.WIF, label string) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyLabel(privKeyWIF *mtcutil.WIF, label string) error {
...
//
// See ImportPrivKey for the blocking version and more details.
func (c *Client) ImportPrivKeyRescanAsync(privKeyWIF *mtcutil.WIF, label string, rescan bool) FutureImportPrivKeyResult {
	wif := ""
	if privKeyWIF != nil {
		wif = privKeyWIF.String()
	}
...
func (c *Client) ImportPrivKeyRescan(privKeyWIF *mtcutil.WIF, label string, rescan bool) error {
