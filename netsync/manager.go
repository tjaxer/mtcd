...
import (
	...
	peerpkg "github.com/tjaxer/mtcd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*mtcutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *mtcutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *mtcutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *mtcutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
