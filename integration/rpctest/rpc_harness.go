...
func New(activeNet *chaincfg.Params, handlers *rpcclient.NotificationHandlers,
	...
	if handlers.OnFilteredBlockConnected != nil {
		...
		handlers.OnFilteredBlockConnected = func(height int32, header *wire.BlockHeader, filteredTxns []*mtcutil.Tx) {
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// wallet.
	filterAddrs := []mtcutil.Address{h.wallet.coinbaseAddr}
...
func (h *Harness) NewAddress() (mtcutil.Address, error) {
...
//
// This function is safe for concurrent access.
func (h *Harness) ConfirmedBalance() mtcutil.Amount {
...
//
// This function is safe for concurrent access.
func (h *Harness) GenerateAndSubmitBlock(txns []*mtcutil.Tx, blockVersion int32,
	blockTime time.Time) (*mtcutil.Block, error) {
...
func (h *Harness) GenerateAndSubmitBlockWithCustomCoinbaseOutputs(
	txns []*mtcutil.Tx, blockVersion int32, blockTime time.Time,
	mineTo []wire.TxOut) (*mtcutil.Block, error) {
	...
	prevBlock := mtcutil.NewBlock(mBlock)
