...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr mtcutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*mtcutil.Tx, error) {
...
func CreateBlock(prevBlock *mtcutil.Block, inclusionTxs []*mtcutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr mtcutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*mtcutil.Block, error) {
	...
	blockTxns := []*mtcutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := mtcutil.NewBlock(&block)
