...
func storeFilter(dbTx database.Tx, block *mtcutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *mtcutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *mtcutil.Block,
