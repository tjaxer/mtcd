...
func (view *UtxoViewpoint) AddTxOut(tx *mtcutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *mtcutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *mtcutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *mtcutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *mtcutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *mtcutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *mtcutil.Tx) (*UtxoViewpoint, error) {
