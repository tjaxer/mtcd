...
func GetBlockWeight(blk *mtcutil.Block) int64 {
...
func GetTransactionWeight(tx *mtcutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *mtcutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
