...
var (
	defaultHomeDir     = mtcutil.AppDataDir("btcd", false)
...
func loadConfig() (*config, []string, error) {
	...
	cfg.minRelayTxFee, err = mtcutil.NewAmount(cfg.MinRelayTxFee)
	if err != nil {
	...
	cfg.miningAddrs = make([]mtcutil.Address, 0, len(cfg.MiningAddrs))
	for _, strAddr := range cfg.MiningAddrs {
		addr, err := mtcutil.DecodeAddress(strAddr, activeNetParams.Params)
		if err != nil {
